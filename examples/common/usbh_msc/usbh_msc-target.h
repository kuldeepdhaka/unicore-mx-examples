...
#ifndef USBH_MSC_TARGET_H
#define USBH_MSC_TARGET_H
...
usbh_backend *usbh_msc_backend(void);
const usbh_backend_config *usbh_msc_config(void);
...
void usbh_msc_before_poll(void);
void usbh_msc_after_poll(void);
